...
@section('content')
    ...
    <div class="modal fade" id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="{{ route('data-beras.importberas') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Import Data Beras CPP</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg">
                                <div class="mb-3">
                                    <label>Import Data Beras CPP</label>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Filter Data Beras Cpp</h5>
                        <div class="row">
                            <div class="col-lg-4">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-beras.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus"></i>
                        Tambah Data Beras Cpp
                    </a>
                </div>
                <div class="card-body">
...
@push('custom-script')
    <script>
        $(document).ready(function() {
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        $('#generateexcel').attr('href',
                            "{{ route('data-beras.generateexcel') }}?start_date=" + startDate +
                            "&end_date=" + endDate);
                    }
                },
                columns: [{
            ...
            var editRoute = "{{ route('data-beras.edit', ':id') }}"
            var deleteRoute = "{{ route('data-beras.destroy', ':id') }}";
            ...
            function format(d) {
                ...
                return '<table>' +
                    '<tr>' +
                    '<td>Edit Data Beras CPP :</td>' +
                    '<td><a href="' + editUrl +
                    '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Data Beras CPP</a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>Hapus Data Beras CPP</td>' +
                    '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                    '@csrf' +
                    '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Data Beras CPP</button>' +
                    '</form></td>' +
                    '</tr>' +
                    '</table>';
            }
