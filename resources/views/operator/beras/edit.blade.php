...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('data-beras.update', $beras->id) }}" method="POST">
                    @csrf
                    <div class="card">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tgl_beras"
                                            ...
                                            value="{{ old('tgl_beras', \Carbon\Carbon::parse($beras->tgl_beras)->format('Y-m-d')) }}">
                                        @error('tgl_beras')
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="penerima"
                                            ...
                                            value="{{ old('penerima', $beras->penerima ?? '-') }}" placeholder="Masukan nama penerima">
                                        @error('penerima')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nik"
                                            ...
                                            value="{{ old('nik', $beras->nik ?? '-') }}" placeholder="Masukan nik">
                                        @error('nik')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="rt"
                                            ...
                                            value="{{ old('rt', $beras->rt ?? '-') }}" placeholder="Masukan rt">
                                        @error('rt')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-control @error('status') is-invalid @enderror"
                                            ...
                                            <option value="1" {{ $beras->status == '1' ? 'selected' : '' }}>Sudah
                                                Diambil</option>
                                            <option value="2" {{ $beras->status == '2' ? 'selected' : '' }}>Belum
                                                Diambil</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="5"
                                            placeholder="Masukan alamat">{{ old('alamat', $beras->alamat ?? '-') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
