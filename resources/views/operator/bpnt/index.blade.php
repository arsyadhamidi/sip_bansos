...
@section('content')
        ...
        <div class="col-lg">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="margin-left: -15px">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Data BPNT</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="modal fade" id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="{{ route('data-bpnt.importbpnt') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Import Data BPNT</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg">
                                <div class="mb-3">
                                    <label>Import Data BPNT</label>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Filter Data BPNT</h5>
                        <div class="row">
                            <div class="col-lg-4">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-bpnt.create') }}" class="btn btn-primary">
...
@push('custom-script')
    <script>
        $(document).ready(function() {
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        $('#generateexcel').attr('href',
                            "{{ route('data-bpnt.generateexcel') }}?start_date=" + startDate +
                            "&end_date=" + endDate);
                    }
                },
                columns: [{
            ...
            var editRoute = "{{ route('data-bpnt.edit', ':id') }}"
            var deleteRoute = "{{ route('data-bpnt.destroy', ':id') }}";
            ...
            function format(d) {
                ...
                return '<table>' +
                    '<tr>' +
                    '<td>Edit Data BPNT :</td>' +
                    '<td><a href="' + editUrl +
                    '"class="btn btn-info"><i class="fa fa-edit"></i> &nbsp; Edit Data BPNT</a></td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td>Hapus Data BPNT</td>' +
                    '<td><form action="' + deleteUrl + '" method="POST" id="dataForm">' +
                    '@csrf' +
                    '<button type="submit" class="btn btn-danger" id="hapusData"><i class="fa fa-times"></i> &nbsp; Hapus Data BPNT</button>' +
                    '</form></td>' +
                    '</tr>' +
                    '</table>';
            }
